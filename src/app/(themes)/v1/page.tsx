// File: src/app/(themes)/v1/page.tsx
...
import { STORAGE_KEYS, TEMPLATE_PRELOAD_W, TEMPLATE_PRELOAD_H, PRELOADER_FADE_MS, PRELOADER_DURATION_MS, PRELOADER_CAROUSEL_READY_DELAY, MORPH_BUTTON_DELAY_MS, MORPH_CLEANUP_MS } from '@/lib/utils/constants';
