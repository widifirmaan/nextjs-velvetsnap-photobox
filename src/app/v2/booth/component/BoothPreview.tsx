...
export default function BoothPreview({
  templateData, captures, keyedFrameImage, filledCount, slotsCount,
    ...
    <>
      {templateData?.templateData?.slotsLayout && (
        <div className={styles.boothPreview}>
          <div className={styles.boothStripPreview}>
            ...
            {keyedFrameImage && <img src={getAutoFormatUrl(keyedFrameImage)} alt="" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none' }} />}
          </div>
